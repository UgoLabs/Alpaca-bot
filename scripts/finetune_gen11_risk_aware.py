...
# GEN11 SETTINGS
# We relax the strict "Holding Loss" penalty because we have the new "Drawdown Penalty"
TrainingConfig.HOLDING_LOSS_PENALTY = 0.0001
TrainingConfig.LOSS_THRESHOLD_PCT = 0.02

# Import the NEW Gen11 Environment
from src.environments.vector_env_gen11 import VectorizedTradingEnv
...
# CONFIGURATION
# =============================================================================
# Start from Ep 475 (The Diamond Hands Model)
# We want to force it to learn safety now
TARGET_MODEL_PATH = "models/swing_gen11_risk_aware_ep475" 
NEW_PREFIX = "models/swing_gen11_risk_aware_ep"

START_EPISODE = 480 # Continuing numbering
NUM_EPISODES = 10   # Short run to find the transition
...
def main():
    ...
    for episode in range(START_EPISODE, TOTAL_EPISODES + 1):
        ...
        # CSV Log
        csv_path = f"logs/trades_swing_gen11_ep{episode}.csv"
