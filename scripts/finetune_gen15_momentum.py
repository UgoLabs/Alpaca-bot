...
# Import the NEW Gen15 Environment
from src.environments.vector_env_gen15_momentum import VectorizedTradingEnv
...
# CONFIGURATION
# =============================================================================
# Start from Ep 482 (The Value Bot)
# Goal: Pivot behavior from Buying Dips to Buying Trend
TARGET_MODEL_PATH = "models/swing_gen11_risk_aware_ep482" 
NEW_PREFIX = "models/swing_gen15_momentum_ep"

START_EPISODE = 560
NUM_EPISODES = 20   
TOTAL_EPISODES = START_EPISODE + NUM_EPISODES - 1

LEARNING_RATE_SCALE = 0.25 # Aggressive learning rate to force the pivot
EPSILON_START = 0.05
EPSILON_MIN = 0.01
DECAY = 0.95
...
def main():
    ...
    for episode in range(START_EPISODE, TOTAL_EPISODES + 1):
        ...
        # CSV Log
        csv_path = f"logs/trades_swing_gen15_ep{episode}.csv"
