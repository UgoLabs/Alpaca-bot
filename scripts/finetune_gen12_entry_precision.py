...
# It has high returns (+470%) but high drawdown (80%).
# Gen12 Environment will fine-tune the ENTRIES to reduce that drawdown.
TARGET_MODEL_PATH = "models/swing_gen11_risk_aware_ep482" 
NEW_PREFIX = "models/swing_gen12_entry_ep"

START_EPISODE = 500
NUM_EPISODES = 20  
TOTAL_EPISODES = START_EPISODE + NUM_EPISODES - 1

LEARNING_RATE_SCALE = 0.20 # Slightly lower learning rate for fine-tuning precision
EPSILON_START = 0.05
EPSILON_MIN = 0.01
DECAY = 0.95
...
def main():
    ...
    for episode in range(START_EPISODE, TOTAL_EPISODES + 1):
        ...
        # CSV Log
        csv_path = f"logs/trades_swing_gen12_ep{episode}.csv"
